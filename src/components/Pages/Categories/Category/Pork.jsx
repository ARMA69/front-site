...
const Pork = () => {
  const { fetchPork, categoryPork, mealId, fetchMealId,clickShowHandler, open } = useContext(myContext); 
  ...
  return (
    ...
    {categoryPork.map((meal) => ( <CategoryMapItem key={meal.idMeal} meal={meal} clickOpenHandler={clickOpenHandler}/>))}
    </div>   
